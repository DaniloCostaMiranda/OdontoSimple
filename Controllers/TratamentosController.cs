...
namespace OdontoSimple.Controllers
{
    public class TratamentosController : Controller
    {
        ...
        [HttpGet]
        public async Task<IActionResult> AddDenteProcedimento(int tratamentoId)
        {

            //pq puxando _denteService, entendo que deveria ser _tratamentoService
            var viewModel = new TratamentoFormViewModel()
            {
